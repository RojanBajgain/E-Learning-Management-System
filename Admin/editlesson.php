...
<div class="col-sm-6 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="lesson_desc" name="lesson_desc" row="2"> <?php if(isset($row['lesson_desc'])) {echo $row['lesson_desc']; } ?>
            </textarea>
        </div>
        <div class="form-group">
        ...
        <div class="text-center">
            ...
            <a href="lessons.php" class="btn btn-dark">Close</a>
        </div>
