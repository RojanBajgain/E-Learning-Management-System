...
if(isset($_REQUEST['requpdate'])) {
    ...
    if( ($_REQUEST['stu_id'] == "" ) || ($_REQUEST['stu_name'] == "" ) || ($_REQUEST['stu_email'] == "" ) || ($_REQUEST['stu_pass'] == "" )
     || ($_REQUEST['stu_occ'] == "" )) {
        ...
        $sql = "UPDATE student SET stu_id = '$sid', stu_name = '$sname', stu_email = '$semail', stu_pass = '$spass',
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <!-- <div class="form-group">
            ...
            <input type="password" class="form-control" id="stu_pass" name="stu_pass" 
                value="<?php /* if(isset($row['stu_pass'])) { echo $row['stu_pass']; } */ ?>" readonly>
        </div> -->
        ...
        <div class="text-center">
            ...
            <a href="students.php" class="btn btn-dark">Close</a>
        </div>
